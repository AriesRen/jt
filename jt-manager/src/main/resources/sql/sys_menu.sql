...
insert into sys_menu(id, menu, url, icon, status, hidden, parentId, createdTime, updatedTime, createdUser, updatedUser, type, note,sort)
VALUES (1, '系统管理', '/system', 'setting', 1,0,null,now(), now(),'admin','admin','1','系统管理',2);

insert into sys_menu(id, menu, url, icon, status, hidden, parentId, createdTime, updatedTime, createdUser, updatedUser,type, note,sort)
VALUES (2, '日志管理', '/logsUI', 'logs', 1,0,1,now(), now(),'admin','admin','1','日志管理',2);

insert into sys_menu(id, menu, url, icon, status, hidden, parentId, createdTime, updatedTime, createdUser, updatedUser,type, note,sort)
VALUES (3, '用户管理', '/userUI', 'user', 1,0,1,now(), now(),'admin','admin','1','用户管理',1);

insert into sys_menu(id, menu, url, icon, status, hidden, parentId, createdTime, updatedTime, createdUser, updatedUser,type, note,sort)
VALUES (4, '系统设置', '/setting', 'setting', 1,0,1,now(), now(),'admin','admin','1','系统设置',1);

insert into sys_menu(id, menu, url, icon, status, hidden, parentId, createdTime, updatedTime, createdUser, updatedUser,type, note,sort)
VALUES (5, '个人中心', '/me', 'user', 1,0,null,now(), now(),'admin','admin','1','个人中心',1);
